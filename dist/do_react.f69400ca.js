...
var render = function render(reactElement, container) {
  ...
  if (['string', 'number'].includes(_typeof(reactElement))) {
    var textElem = document.createTextNode(reactElement.toString());
    return container.appendChild(textElem);
  }

  var actualDomElement = document.createElement(reactElement === null || reactElement === void 0 ? void 0 : reactElement.tag);

  if (reactElement === null || reactElement === void 0 ? void 0 : reactElement.props) {
    Object.keys(reactElement.props).filter(function (p) {
      return p !== 'children';
    }).forEach(function (p) {
      return actualDomElement[p] = reactElement.props[p];
    });
  }

  if ((_a = reactElement === null || reactElement === void 0 ? void 0 : reactElement.props) === null || _a === void 0 ? void 0 : _a.children) {
...
//# sourceMappingURL=/do_react.f69400ca.js.map